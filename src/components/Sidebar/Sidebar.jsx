...
export default function Sidebar() {
  ...
  return (
    <>
      <button className="btn btn-open" onClick={() => setsidebarVisibility(true)}><i className="fas fa-bars"></i></button>
      <div className={sidebarVisible ? 'sidebar show' : 'sidebar'}>
        <button className="btn btn-close" onClick={() => setsidebarVisibility(false)}><i className="fas fa-times"></i></button>
